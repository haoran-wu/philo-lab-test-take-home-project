...
This produced 30 failure instances distributed across the six categories (Table~\ref{tab:distribution}). All instances are human=FAIL by construction; we do not include negative controls in this study.
...
Character / Human Consistency & 6 \\
Temporal Coherence / State Evolution & 3 \\
Shadow / Lighting Physics & 3 \\
\midrule
Total & 30 \\% TODO: add camera movement if applicable
\bottomrule
\end{tabular}
\end{table}
...
Character Consistency & 0\% (n=4) & 0\% (n=4) & \textbf{50\%} (n=4) & 25\% (n=4) \\
